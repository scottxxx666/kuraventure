...
export const demoStage: StageDef = {
    ...
    triggers: [
        ...
        },
        {
            // Optional + repeatable, like pizza-run.
            id: 'dance',
            at: { objectName: 'trigger-dance' },
            activity: { type: 'minigame', sceneKey: SceneKeys.Dance },
            required: false,
            once: false
        },
        {
        ...
        },
        {
            // Optional + repeatable, like pizza-run.
            id: 'jump-rope',
            at: { objectName: 'trigger-rope' },
            activity: { type: 'minigame', sceneKey: SceneKeys.JumpRope },
            required: false,
            once: false
        },
        {
